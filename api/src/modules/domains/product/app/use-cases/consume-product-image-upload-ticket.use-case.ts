...
import type { ProductImageUploadTicketRecord } from './issue-product-image-upload-url.use-case';
import { buildTicketCacheKey } from './issue-product-image-upload-url.use-case';
