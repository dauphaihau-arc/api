...
import { CategoryQueryRepository } from '~/modules/domains/category/app/ports/category-query.repository';
import { TextGenerationService } from '~/modules/shared/ai/app/ports/text-generation.service';
