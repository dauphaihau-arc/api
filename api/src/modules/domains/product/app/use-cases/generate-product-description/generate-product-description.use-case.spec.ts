import type { CategoryQueryRepository } from '~/modules/domains/category/app/ports/category-query.repository';
import type { TextGenerationService } from '~/modules/shared/ai/app/ports/text-generation.service';
