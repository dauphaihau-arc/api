...
export class Migration20260515000100 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "orders" ("id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "user_id" uuid not null, "shop_id" uuid not null, "payment_type" varchar(20) not null, "status" varchar(30) not null, "shipping_status" varchar(30) not null, "currency" varchar(3) not null, "subtotal" numeric(12,2) not null, "total_shipping_fee" numeric(12,2) not null default 0, "total_discount" numeric(12,2) not null default 0, "total" numeric(12,2) not null, "note" text null, "promo_codes" text[] not null default '{}', "shipping_address" jsonb not null, "shipping_origin_countries" text[] not null default '{}', "shipping_to_country" varchar(2) not null, "shipping_estimated_delivery" timestamptz not null, "payment_details" jsonb null, constraint "orders_pkey" primary key ("id"));`);
